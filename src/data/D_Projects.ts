...
import img_projects_5_1 from "../img/projects/image_projects_5_1.png";
import img_projects_5_2 from "../img/projects/image_projects_5_2.png";
...
const D_Projects: projectsType[] = [
  {
    ...
    summary:
      "유의미한 공간 정보를 간단하고 효과적으로 활용하기 위한 시스템으로 비용 절감 및 업무 효율 향상을 목적으로 함",
    desc: [
  ...
  },
  {
    ...
    img: [img_projects_3_1, img_projects_3_2],
    mov: [],
  ...
  },
  {
    ...
    img: [img_projects_2_1, img_projects_2_2, img_projects_2_3],
    mov: [],
  ...
  },
  {
    ...
    summary:
      "현물, 파생 상품과 소셜 암호화 트레이딩을 제안하는 암호화 거래 플랫폼",
    desc: [
      "Web Publishing",
      "React front 개발",
      "materialUI를 활용한 UI 구현",
  ...
  {
    id: 5,
    name: "Recruit Web Mobile Migration Project",
    start: "2022-09",
    end: "2022-10",
    summary: "구인/구직 채용 중개 플랫폼",
    desc: [
      "Web Publishing",
      "NextJs front 개발",
      "Git-flow 활용",
    ...
    img: [img_projects_5_1, img_projects_5_2],
    mov: [],
  },
];
